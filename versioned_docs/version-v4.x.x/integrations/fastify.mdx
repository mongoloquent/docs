...
src="https://github.com/mongoloquent/fastify/raw/main/assets/fastify.svg"
...
You can find the API reference for the `@mongoloquent/fastify` package [here](https://api.fastify.mongoloquent.com).
