...
<Tabs>
  ...
  <TabItem value="Javascript" label="Javascript">
    ```javascript
    import { Model } from '@mongoloquent/core';
    import Phone from './Models/Phone';
...
<Tabs>
    ...
    class Image extends Model<IImage> {
      ...
      public function post() {
        return this.morphTo(Post, "imageable");
      }

      /**
       * Get the parent imageable model (user).
       */
      public function user() {
        return this.morphTo(User, "imageable");
      }
    }
...
<Tabs>
    ...
    class Comment extends Model<IComment> {
      ...
      */
      ...
      /**
       * Get the parent commentable model (video).
      */
